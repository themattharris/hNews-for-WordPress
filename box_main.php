...
<fieldset id="hnews_license">
  ...
  <div>
    ...
    <input name="hnews_license_url" type="text" class="code" id="hnews_license_url" value="<?php echo esc_attr($license_url); ?>" /><br />
  </div>

  <div>
    <label for="hnews_license_text"><?php _e('License name:') ?></label>
    <input name="hnews_license_text" type="text" id="hnews_license_text" value="<?php echo esc_attr($license_text); ?>" /><br />
  </div>
</fieldset>