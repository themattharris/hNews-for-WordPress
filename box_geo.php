<fieldset>
  <div>
    ...
    <input name="hnews_geo_latitude" type="text" size="13" id="hnews_geo_latitude" value="<?php echo esc_attr( $post->hnews_geo_latitude ); ?>" />
  </div>
  <div>
    <label for="hnews_geo_longitude"><?php _e('Longitude:') ?></label>
    <input name="hnews_geo_longitude" type="text" size="13" id="hnews_geo_longitude" value="<?php echo esc_attr( $post->hnews_geo_longitude ); ?>" />
  </div>
